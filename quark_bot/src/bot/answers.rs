...
use super::handler::{
    ...
    handle_login_user, handle_new_chat, handle_reasoning_chat, handle_monitor, handle_mod,
};
...
pub async fn answers(
    ...
    match cmd {
        ...
        Command::Monitor(param) => {
            handle_monitor(bot, msg, param).await?;
        }
        Command::Mod => {
            handle_mod(bot, msg).await?;
        }
