...
pub fn get_admin() -> Result<(AccountAddress, Ed25519PrivateKey), ConsumerError> {
...
pub fn get_reviewer_priv_acc() -> Result<(AccountAddress, Ed25519PrivateKey), ConsumerError> {
